...
def show_overs_unders_ht():
    ...
    st.write("")
    st.header("Over 0,5 HT")
    st.write("")
    st.write("")
    st.write("")
    st.write("")
    st.header("Under 0,5 HT")
    st.write("")
    st.write("")
    st.write("")
    st.write("")
    st.header("Over 1,5 HT")
    st.write("")
    st.write("")
    st.write("")
    st.write("")
    st.header("Under 1,5 HT")
    st.write("")
    st.write("")
    st.write("")
    st.write("")
    st.header("Over 2,5 HT")
    st.write("")
    st.write("")
    st.write("")
    st.write("")
    st.header("Under 2,5 HT")
    st.write("")
    st.write("")
    st.write("")
    st.write("")